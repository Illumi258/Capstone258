            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;">
                        <!--      <img src="images/logo.jpg"  width="15% "/> --> Petshop Online Appointment Website</h4></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-right wow fadeInDown">
                    <ul class="nav navbar-nav">
						...
						<li class="active"><a href="Appointment.php">Get an Appointment<a/></li>
...
<section id="tour-packages" class="center wow fadeInDown">
    <div style="font-size:30px; font-family:verdana; font-weight:bold; color: #8B8B00; text-align:center;">Appointment</div>

...
<body style="background-image:url(try3.jpg)">
	...
	<center><br>
		<label style="color:black"><b>Doctor:</b></label><br>
		<select name="doctor" id="doctor-list" class="demoInputBox" style="width:70%;height:45px;border-radius:9px">
		...
		<input type="date"   style="width:70%;height:45px;border-radius:9px" name="dateselected" required><br><br>
		<br>

...
<label style="font-size:20px" >City:</label>
		...
		<table>
		<tr><td><input type="checkbox" value="Monday" name="daylist[]"/><td>Monday&nbsp;</td></td>
		<td><input type="checkbox" value="Tuesday" name="daylist[]"/><td>Tuesday&nbsp;</td> </td>
		<td><input type="checkbox" value="Wednesday" name="daylist[]"/></td><td>Wednesday&nbsp;</td> </tr>
		
	
		<tr><td><input type="checkbox" value="Thursday" name="daylist[]"/><td>Thursday&nbsp;</td></td>
		<td><input type="checkbox" value="Friday" name="daylist[]"/></td><td>Friday&nbsp;</td> </t>
		<td><input type="checkbox" value="Saturday" name="daylist[]"/></td><td>Saturday&nbsp;</td> </tr></tr>
		</table>
	<div style="background-image:url(try3.jpg)
"
		Availability(12 hour Format):<br><br>

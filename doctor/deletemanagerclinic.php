            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <li class="active">
                    ...
                    <ul id="submenu-2" class="collapse">
                        ...
                        <li><a href="deletedoctorclinic.php"><i class="fa fa-angle-double-right"></i> RemoveVeterinarian from Clinic</a></li>
...
<center><h1>REMOVE MANAGER FROM A CLINIC</h1><br>
...
if(isset($_POST['Submit']))
{
	...
	if (mysqli_query($conn, $sql1)) 
				...
				{
					echo "Please fill up the field above: Error ";
				}
}

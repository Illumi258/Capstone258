            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				...
				<a href="#" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-user-plus"></i> Veterinarian <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                    <ul id="submenu-1" class="collapse">
                        ...
                        <li><a href="deletedoctor.php"><i class="fa fa-angle-double-right"></i> Delete Veterinarian</a></li>
                ...
                <li>
                    ...
                    <ul id="submenu-2" class="collapse">
                        ...
                        <li><a href="deleteclinic.php"><i class="fa fa-angle-double-right"></i> Delete Clinic</a></li>
                        ...
                        <li><a href="deletedoctorclinic.php"><i class="fa fa-angle-double-right"></i> Delete Veterinarian from Clinic</a></li>
                        <li><a href="deletemanagerclinic.php"><i class="fa fa-angle-double-right"></i> Delete Manager from Clinic</a></li>
...
if(isset($_POST['Submit']))
{
    ...
    $query = "INSERT INTO activitylog1 (activity) VALUE ('Add Veterinarians')";

...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="cal.png" width="30px" height="30px"><strong> Petshop </strong>Online Appointment System</a></li>
			...
			<div class="center">
				<h1>Petshop</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Online Appointment System</p><br>

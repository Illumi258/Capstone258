                            ...
                            while ($patientRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                   echo "<td>" . $patientRow['name'] . "</td>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$patientRow['name']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";

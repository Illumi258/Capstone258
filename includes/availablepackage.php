                	...
                	<table>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td style="text-align:center;"> <input type="file" accept="image/*" id="image" name="image" required /></td>
                        </tr>
...
//
                                move_uploaded_file($_FILES["image"]["tmp_name"], "DogFood" . $_FILES["image"]["name"]);
                                $location = "DogFood" . $_FILES["image"]["name"];

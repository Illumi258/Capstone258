...
<head>
    ...
    <link href="assets/css/bootstrap-clockpicker.js" rel="stylesheet">
    <link href="assets/css/bootstrap-clockpicker.min.css" rel="stylesheet">
    <link href="assets/css/bootstrap-clockpicker.min.js" rel="stylesheet">
    <link href="assets/css/jquery-clockpicker.css" rel="stylesheet">  
    <link href="assets/css/jquery-clockpicker.js" rel="stylesheet">
    <link href="assets/css/jquery-clockpicker.min" rel="stylesheet">
	<link href="assets/css/jquery-clockpicker.min.js" rel="stylesheet">
        ...
        <section id="contact-info">
            ...
            <div class="left wow fadeInDown">
               ...
               <div class="col-md-6">
                <p class="lead">
                    <br>
                    <p><span style="font-size:20px; font-weight:bold; font-family:verdana; color:red;">Benny Dave Samuyag</span>
                    <br><b>Address:</b> 496 F. Legaspi st. Ext. Maybunga Pasig City <b><br>Tel/Phone:</b> +639550295097 / 09662951169<b><br>Email Address:</b> Samuyag_bennydave@plpasig.edu.ph</p>
                    <hr>
...
<?php include('includes/footer.php');?><!--/#footer-->
	...
	<link href="assets/js/clockpicker.css" rel="stylesheet">
    <link href="assets/js/clockpicker.js" rel="stylesheet">
    <link href="assets/js/standalone.css" rel="stylesheet">
</body>
</html>

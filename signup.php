...
label{
	color: #000;
				...
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/logolast1.png" width="30px" height="30px"><strong> Veterinary </strong>Clinic Appointment </a></li>
...
<form action="signup.php" method="post">
	<div class="sucontainer" style="background-color: #ffff">
		...
		<input type="date" name="dob" min="1900-01-01" max="2000-12-31" required><br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp; -->
 to our 
    ...
    <a href="#modalScrollableCenter" data-toggle="modal">Terms & Conditions</a>
		<br> <br>
			<button type="button"  class="cancelbtn"><a href="cover.php"> Cancel</a></button>
...
<script Type="signup">alert("JavaScript Alert Box by PHP")</script>	
...
echo ' alert("Booking Successfully")';  //not showing an alert box.
echo '</script>';

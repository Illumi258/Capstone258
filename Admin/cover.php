<!DOCTYPE html>
<html>
<body style="background-image:url(images/umaylods.png)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/logolast1.png" width="35px" height="35px"><strong> Veterinary </strong> Clinic Appointment </a></li>
					<li><a href="index.php">Petshop</a></li>
			...
			<div class="center">
				<h1>Veterinary</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%">Clinic Appointment </p><br>
				<button onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:50%;left:45%">Login</button>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					...
					<li><a href="signup.php">Client Sign Up</a></li>
				</ul>
			</div>

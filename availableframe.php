...
<!--*********************************************START OF NAVIGATION BAR****************************************--> 
        ...
        ?>
                    ...
                    <td  style="border: 1px dashed #8c8b8b;"><center><strong class="wow fadeInDown"><p style="margin-top:25px;">No.<?php echo $count;?></p></strong></center></td>
                    	<td style="border: 1px dashed #8c8b8b;"><center>
						<td style="border: 1px dashed #8c8b8b; width=30%"><center><img src="<?php echo $row['image']?>" height= "300px"; width="1020px"; class="img-responsive img-rounded wow fadeInDown"></center></td>

  ...
  <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
						...
						<?php
error_reporting(0);
$conn = mysqli_connect("localhost","root","","wt_database")or die(mysqli_error());
$query = "SELECT SUM(Payment) AS sum FROM 'book'";

$query_result1 = mysqli_query($conn, $query);

while($row1 = mysqli_fetch_assoc($query_result1)){
	
	$output = " Total score Team"." ".$row1['sum'];
}
...
return false;
 ...
 <script type="text/javascript">
        ...
        <div class="d-flex w-100 justify-content-end">
            <a href="Paymentpaypal.php" class="btn btn-sm btn-flat btn-dark">      Checkout</a>
        </div>
</body>
</html>
